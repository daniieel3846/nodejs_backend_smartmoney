...
const crearCategoria = async (req, res) => {
    ...
    if (!nuevaCategoria || !nuevaCategoria.NombreCategoria || !nuevaCategoria.TipoCategoria) {
    ...
    try {
        ...
        const result = await connection.query(
            'INSERT INTO Categorias (NombreCategoria, TipoCategoria) VALUES (?, ?)',
            [nuevaCategoria.NombreCategoria, nuevaCategoria.TipoCategoria]
        );
